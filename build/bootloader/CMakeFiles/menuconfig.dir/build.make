...
CMakeFiles/menuconfig:
	/home/ubuntu/.espressif/python_env/idf6.0_py3.13_env/bin/python /tmp/esp-idf/tools/kconfig_new/prepare_kconfig_files.py --list-separator=semicolon --env-file /workspace/build/bootloader/config.env
	/home/ubuntu/.espressif/python_env/idf6.0_py3.13_env/bin/python -m kconfgen --list-separator=semicolon --kconfig /tmp/esp-idf/Kconfig --sdkconfig-rename /tmp/esp-idf/sdkconfig.rename --config /workspace/sdkconfig --env IDF_MINIMAL_BUILD=n --env-file /workspace/build/bootloader/config.env --env IDF_TARGET=esp32s3 --env IDF_TOOLCHAIN=gcc --env IDF_ENV_FPGA= --env IDF_INIT_VERSION=5.4.0 --dont-write-deprecated --output config /workspace/sdkconfig
	/home/ubuntu/.espressif/python_env/idf6.0_py3.13_env/bin/python /tmp/esp-idf/tools/check_term.py
	/usr/bin/cmake -E env COMPONENT_KCONFIGS_SOURCE_FILE=/workspace/build/bootloader/kconfigs.in COMPONENT_KCONFIGS_PROJBUILD_SOURCE_FILE=/workspace/build/bootloader/kconfigs_projbuild.in KCONFIG_CONFIG=/workspace/sdkconfig IDF_TARGET=esp32s3 IDF_TOOLCHAIN=gcc IDF_ENV_FPGA= IDF_INIT_VERSION=5.4.0 IDF_MINIMAL_BUILD=n /home/ubuntu/.espressif/python_env/idf6.0_py3.13_env/bin/python -m menuconfig /tmp/esp-idf/Kconfig
	/home/ubuntu/.espressif/python_env/idf6.0_py3.13_env/bin/python -m kconfgen --list-separator=semicolon --kconfig /tmp/esp-idf/Kconfig --sdkconfig-rename /tmp/esp-idf/sdkconfig.rename --config /workspace/sdkconfig --env IDF_MINIMAL_BUILD=n --env-file /workspace/build/bootloader/config.env --env IDF_TARGET=esp32s3 --env IDF_TOOLCHAIN=gcc --env IDF_ENV_FPGA= --env IDF_INIT_VERSION=5.4.0 --output config /workspace/sdkconfig
