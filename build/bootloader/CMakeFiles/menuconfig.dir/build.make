...
CMakeFiles/menuconfig:
	...
	/home/ubuntu/.espressif/python_env/idf5.4_py3.13_env/bin/python -m kconfgen --list-separator=semicolon --kconfig /workspace/esp-idf/Kconfig --sdkconfig-rename /workspace/esp-idf/sdkconfig.rename --config /workspace/sdkconfig --env-file /workspace/build/bootloader/config.env --env IDF_TARGET=esp32 --env IDF_TOOLCHAIN=gcc --env IDF_ENV_FPGA= --env IDF_INIT_VERSION=5.4.0 --dont-write-deprecated --output config /workspace/sdkconfig
	/home/ubuntu/.espressif/python_env/idf5.4_py3.13_env/bin/python /workspace/esp-idf/tools/check_term.py
	/usr/bin/cmake -E env COMPONENT_KCONFIGS_SOURCE_FILE=/workspace/build/bootloader/kconfigs.in COMPONENT_KCONFIGS_PROJBUILD_SOURCE_FILE=/workspace/build/bootloader/kconfigs_projbuild.in KCONFIG_CONFIG=/workspace/sdkconfig IDF_TARGET=esp32 IDF_TOOLCHAIN=gcc IDF_ENV_FPGA= IDF_INIT_VERSION=5.4.0 /home/ubuntu/.espressif/python_env/idf5.4_py3.13_env/bin/python -m menuconfig /workspace/esp-idf/Kconfig
	/home/ubuntu/.espressif/python_env/idf5.4_py3.13_env/bin/python -m kconfgen --list-separator=semicolon --kconfig /workspace/esp-idf/Kconfig --sdkconfig-rename /workspace/esp-idf/sdkconfig.rename --config /workspace/sdkconfig --env-file /workspace/build/bootloader/config.env --env IDF_TARGET=esp32 --env IDF_TOOLCHAIN=gcc --env IDF_ENV_FPGA= --env IDF_INIT_VERSION=5.4.0 --output config /workspace/sdkconfig
